...
import emprtCart from '../../assets/images/emptycart.gif';
...

                    {
                        cartData?.length !== 0 ?
                            ...
                            <div className="empty d-flex align-items-center justify-content-center flex-column">
                                <img src={emprtCart} width="200" />
                                <h3>Your Cart is currently empty</h3>
                                <br />
                                <Link to="/"> <Button className='btn-blue bg-green btn-lg btn-big btn-round'><FaHome /> &nbsp; Continue Shopping</Button></Link>
                            </div>
